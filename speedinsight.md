...
<img src="https://domfesasl.com/wp-content/uploads/2020/12/chorreado-con-arena.jpg" alt="Máquina de chorreo de arena" loading="lazy" decoding="async" width="1024" height="683" class="relative z-10 shadow-2xl w-full h-auto object-cover grayscale hover:graysc…">
...
<section id="marmolista" class="py-0 flex flex-col md:flex-row-reverse bg-marble-dark text-white overflow-…">
Grandes formatos, escaleras y frentes decorativos. Instalación precisa y asesor…
<p class="text-sm text-gray-500">
MAESTRÍA MARMOLISTA Diseño y Fabricación en Piedra Natural Encimeras, suelos y…
<section id="marmolista" class="py-0 flex flex-col md:flex-row-reverse bg-marble-dark text-white overflow-…">
Proyectos personalizados con selección de veta, acabados y detalles artesanales…
<p class="text-sm text-gray-500">
MAESTRÍA MARMOLISTA Diseño y Fabricación en Piedra Natural Encimeras, suelos y…
<section id="marmolista" class="py-0 flex flex-col md:flex-row-reverse bg-marble-dark text-white overflow-…">
